                                        ...
                                        <div class="modal-body">
                                            <form method="post" name="submit">
                                                <table class="table table-bordered table-hover">
                                                    <tr>
                                                        <th>Blood Pressure :</th>
                                                        <td><input name="bp" placeholder="Blood Pressure" class="form-control" required></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Blood Sugar :</th>
                                                        <td><input name="bs" placeholder="Blood Sugar" class="form-control" required></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Weight :</th>
                                                        <td><input name="weight" placeholder="Weight" class="form-control" required></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Body Temperature :</th>
                                                        <td><input name="temp" placeholder="Body Temperature" class="form-control" required></td>
                                                    </tr>
                                                    <!-- <tr>
                                                        <th>Prescription :</th>
                                                        <td><textarea name="pres" placeholder="Medical Prescription" rows="5" class="form-control" required></textarea></td>
                                                    </tr> -->
                                                </table>
                                        </div>
