...
if (isset($_POST['submit'])) {
    ...
    $sql = mysqli_query($con, "SELECT password FROM em_doctors WHERE id='$did' AND password='$cpass'");
    $num = mysqli_fetch_array($sql);

    if ($num) {
        // Update new password
        $update = mysqli_query($con, "UPDATE em_doctors SET password='$npass', updationDate='$currentTime' WHERE id='$did'");
...
<html lang="en">
<head>
    <title>Emergency Doctor | Change Password</title>
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Emergency Doctor | Change Password</h1>
                        </div>
                        <ol class="breadcrumb">
