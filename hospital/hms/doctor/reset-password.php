...
if (!isset($_SESSION['email']) || !isset($_SESSION['cnumber']) || !isset($_SESSION['usertype'])) {
...
if (isset($_POST['change'])) {
    ...
    $usertype = $_SESSION['usertype']; // either 'doctor' or 'emergency_doctor'
    ...
    $query = mysqli_query($con, "UPDATE $table SET password='$newpassword' WHERE $contactCol='$cno' AND $emailCol='$email'");
    if ($query) {
...
<head>
    ...
    <title>Doctor Password Reset | MEDIZEN</title>
