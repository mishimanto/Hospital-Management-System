  ...
  <div class="container-fluid d-flex justify-content-between align-items-center">
    ...
    <a class="navbar-brand d-flex align-items-center text-white fw-bold" href="../index.php" style="gap: 10px;">
      <div style="height:35px;width:35px;overflow:hidden; display:flex; align-items:center; justify-content:center;">
        <img src="logo_no_bg.png" alt="MediZen Logo" style="height: 35px; width: auto;">
      </div>
    ...
    <?php if (isset($_SESSION['id'])): ?>
      <div class="user-auth-container d-flex align-items-center position-relative">
        <span style="font-size: 17px;" class="username-display fw-bold text-capitalize text-truncate me-2" style="max-width: 150px;">
    ...
    <?php else: ?>
      <a href="user-login.php" class="btn custom-login-btn px-3" title="Login">
        <i class="fas fa-sign-in-alt me-1"></i> 
        <span class="d-none d-sm-inline">Login</span>
      </a>
    <?php endif; ?>

<!-- Make sure this is included AFTER jQuery and BEFORE your custom scripts -->
