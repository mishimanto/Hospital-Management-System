...
<body>
        ...
        <div class="login-card">
           ...
           <!--  <div class="logo">
            ...
            <form class="form-login" method="post">
                <!-- <h2 class="form-title">Patient Password Recovery</h2>
                <p class="form-description">
                    Please enter your registered full name and email to recover your password.
                </p> -->
    ...
    <!-- Font Awesome for icons (loaded from CDN but can be self-hosted) -->
