...
if (strlen($_SESSION['id'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "INSERT INTO doctors(specilization, doctorName, address, docFees, contactno, docEmail, password, visiting_start_time, visiting_end_time) 
            VALUES ('$docspecialization', '$docname', '$docaddress', '$docfees', '$doccontactno', '$docemail', '$password', '$visiting_start_time', '$visiting_end_time')");
                                        ...
                                        <div class="panel-body">
                                            <form role="form" name="adddoc" method="post" onSubmit="return valid();">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="time" name="visiting_start_time" class="form-control" required>
                                                </div>
                                                <div class="form-group">
                                                    <label for="visiting_end_time">Visiting End Time</label>
                                                    <input type="time" name="visiting_end_time" class="form-control" required>
                                                </div>
                                                <div class="form-group">
