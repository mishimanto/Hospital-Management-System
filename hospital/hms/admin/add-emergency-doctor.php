...
if (strlen($_SESSION['id'] == 0)) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "INSERT INTO em_doctors (name, specialization, qualification, shift, contact, email, password, available) 
        VALUES ('$name', '$specialization', '$qualification', '$shift_time', '$doccontactno', '$docemail', '$password', 1)");

        if ($sql) {
            echo "<script>alert('Doctor info added Successfully');</script>";
            echo "<script>window.location.href ='manage-emergency-doctors.php'</script>";
        } else {
            echo "<script>alert('Error adding doctor. Please check inputs and try again');</script>";
        }
    }
?>
        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h1 class="mainTitle">Admin | Add Emergency Doctor</h1>
                        </div>
                        <ol class="breadcrumb">
                                        ...
                                        <div class="panel-body">
                                            <form role="form" name="adddoc" method="post" onSubmit="return valid();">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="shift_time" class="form-control" placeholder="e.g. 6 PM - 2 AM" required>
                                                </div>
                                                <div class="form-group">
