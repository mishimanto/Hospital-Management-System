...
<html lang="en">
<head>
    <title>Admin | Date Range Revenue Report</title>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle">Admin | Date Range Revenue Report</h1>
                            </div>
                            <ol class="breadcrumb">
                                <li><span>Admin</span></li>
                                <li class="active"><span>Revenue Report</span></li>
                            </ol>
                        </div>
                    </section>
                            ...
                            <div class="col-lg-10 col-xl-9">
                                ...
                                <div class="combined-summary-card" style="margin-bottom: 50px;">
                                    ...
                                    <div class="date-range-card p-3 bg-light rounded mb-4" style="margin-top: 3%;">
                                        <h5 class="text-center mb-0">
                                            ...
                                            Report Period: 
                                            <span class="font-weight-bold text-info"><?php echo date('M d, Y', strtotime($fdate)); ?></span> 
                                            to 
                                            <span class="font-weight-bold text-info"><?php echo date('M d, Y', strtotime($tdate)); ?></span>
                                        </h5>
                                    </div>
                                    <div class="row text-center" style="margin-top: 3%;">
                                        ...
                                        $appointmentSummary = mysqli_query($con, "
                                            ...
                                            FROM appointment
                                            WHERE DATE(appointmentDate) BETWEEN '$fdate' AND '$tdate'
                                        ...
                                        $ambulanceSummary = mysqli_query($con, "
                                            ...
                                            WHERE DATE(booking_time) BETWEEN '$fdate' AND '$tdate'
                                            AND status = 'Paid'
                                        ");
                                        ...
                                        $testSummary = mysqli_query($con, "
                                            ...
                                            FROM test_orders
                                            WHERE DATE(created_at) BETWEEN '$fdate' AND '$tdate'
                                            AND payment_status = 'Paid'
                                        ");
                                        ...
                                        $bedSummary = mysqli_query($con, "
                                            ...
                                            WHERE DATE(admission_date) BETWEEN '$fdate' AND '$tdate'
                                            AND payment_status = 'Paid'
                                        ");
                                        ...
                                        <!-- <div class="col-md-3 mb-3">
                                            <div class="card bg-light">
                                                <div class="card-body">
                                                    ...
                                                    <h4 class="text-primary"><?php echo $combinedTransactions; ?></h4>
                                                    <p class="text-muted mb-0">All paid transactions</p>
                                                </div>
                                            </div>
                                        </div> -->
                                        <div class="col-md-3 mb-3">
                                ...
                                <div class="report-header mb-5">
                                    <div class="monthly-summary-card">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h3 class="tittle-w3-agileits mb-3 text-primary">Appointments Report</h3>
                                                <h5 class="mb-0">
                                                    <i class="far fa-calendar-alt mr-2"></i>
                                                    Date Range: 
                                                    <span class="font-weight-bold text-info"><?php echo date('M d, Y', strtotime($fdate)); ?> to <?php echo date('M d, Y', strtotime($tdate)); ?></span>
                                                </h5>
                                            </div>
                                    ...
                                    <table class="table table-bordered table-hover" id="report-table">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = mysqli_query($con, "
                                                ...
                                                WHERE DATE(appointment.appointmentDate) BETWEEN '$fdate' AND '$tdate'
                                            ...
                                            <?php 
                                                ...
                                                echo '<tr><td colspan="7" class="text-center py-4 text-muted">No appointments found for this date range</td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                ...
                                <div class="report-header mb-5 mt-5" style="margin-top: 30px;">
                                    <div class="monthly-summary-card">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h3 class="tittle-w3-agileits mb-3 text-primary">Ambulance Report</h3>
                                                <h5 class="mb-0">
                                                    <i class="far fa-calendar-alt mr-2"></i>
                                                    Date Range: 
                                                    <span class="font-weight-bold text-info"><?php echo date('M d, Y', strtotime($fdate)); ?> to <?php echo date('M d, Y', strtotime($tdate)); ?></span>
                                    ...
                                    <table class="table table-bordered table-hover" id="ambulance-report-table">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = mysqli_query($con, "
                                                ...
                                                WHERE DATE(ambulance_bookings.booking_time) BETWEEN '$fdate' AND '$tdate'
                                            ...
                                            <?php 
                                                ...
                                                echo '<tr><td colspan="6" class="text-center py-4 text-muted">No ambulance bookings found for this date range</td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                        <tfoot class="bg-light">
                                ...
                                <div class="report-header mb-5 mt-5" style="margin-top: 30px;">
                                    <div class="monthly-summary-card">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <h3 class="tittle-w3-agileits mb-3 text-primary">Diagnostic Tests Report</h3>
                                                <h5 class="mb-0">
                                                    <i class="far fa-calendar-alt mr-2"></i>
                                                    Date Range: 
                                                    <span class="font-weight-bold text-info"><?php echo date('M d, Y', strtotime($fdate)); ?> to <?php echo date('M d, Y', strtotime($tdate)); ?></span>
                                    ...
                                    <table class="table table-bordered table-hover" id="test-report-table">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = mysqli_query($con, "
                                                ...
                                                WHERE DATE(test_orders.created_at) BETWEEN '$fdate' AND '$tdate'
                                            ...
                                            <?php 
                                                ...
                                                echo '<tr><td colspan="7" class="text-center py-4 text-muted">No diagnostic tests found for this date range</td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                        <tfoot class="bg-light">
                                    ...
                                    <table class="table table-bordered table-hover" id="bed-report-table">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = mysqli_query($con, "
                                                ...
                                                WHERE DATE(ba.admission_date) BETWEEN '$fdate' AND '$tdate'
                                            ...
                                            <?php 
                                                ...
                                                echo '<tr><td colspan="9" class="text-center py-4 text-muted">No bed assignments found for this date range</td></tr>';
                                            }
                                            ?>
                                        </tbody>
                                        <tfoot class="bg-light">
